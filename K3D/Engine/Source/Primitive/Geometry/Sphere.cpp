...
K3D::Sphere::Sphere(std::shared_ptr<GameHeap>& heap) :
...
void K3D::Sphere::Update()
{
}

void K3D::Sphere::Draw(std::shared_ptr<CommandList>& cmdList)
{
	this->_graphicsComponent->Draw(cmdList, this, nullptr, _modelMesh.get());

}

void K3D::Sphere::Initialize()
{
	CreateMesh();
	this->CreateDescriptors();
}

void K3D::Sphere::CreateMesh()
{
...
void K3D::Sphere::CreateDescriptors()
{
