...
HRESULT K3D::PipelineStateObject::Initialize(std::string name, D3D12_GRAPHICS_PIPELINE_STATE_DESC & gpsDesc, ID3DBlob * shader)
{
	if (shader != nullptr) {
...
HRESULT K3D::PipelineStateObject::Initialize(std::shared_ptr<D3D12Device>& device, std::string name, D3D12_GRAPHICS_PIPELINE_STATE_DESC & gpsDesc, ID3DBlob * shader)
{
	if (shader != nullptr) {
		GraphicsContextManager::GetInstance().CreateRootSignature(name + "RootSignature", shader);
		_rootSignature = GraphicsContextManager::GetInstance().GetRootSignature(name + "RootSignature");
...
HRESULT K3D::PipelineStateObject::Initialize(std::string name, D3D12_COMPUTE_PIPELINE_STATE_DESC & cpsDesc, ID3DBlob * shader)
{
	if (shader != nullptr) {
		GraphicsContextManager::GetInstance().CreateRootSignature(name + "RootSignature", shader);
		_rootSignature = GraphicsContextManager::GetInstance().GetRootSignature(name + "RootSignature");
...
HRESULT K3D::PipelineStateObject::Initialize(std::shared_ptr<D3D12Device>& device, std::string name, D3D12_COMPUTE_PIPELINE_STATE_DESC & cpsDesc, ID3DBlob * shader)
{
	if (shader != nullptr) {
		GraphicsContextManager::GetInstance().CreateRootSignature(name + "RootSignature", shader);
		_rootSignature = GraphicsContextManager::GetInstance().GetRootSignature(name + "RootSignature");
...
HRESULT K3D::PipelineStateObject::Initialize(std::string name, D3D12_GRAPHICS_PIPELINE_STATE_DESC & gpsDesc, std::weak_ptr<RootSignature> rootSignature)
{
...
HRESULT K3D::PipelineStateObject::Initialize(std::shared_ptr<D3D12Device>& device, std::string name, D3D12_GRAPHICS_PIPELINE_STATE_DESC & gpsDesc, std::weak_ptr<RootSignature> rootSignature)
{
	_rootSignature = rootSignature;
	gpsDesc.pRootSignature = _rootSignature.lock()->GetSignature().Get();
	auto hr = device->GetDevice()->CreateGraphicsPipelineState(&gpsDesc, IID_PPV_ARGS(&_pipelineState));
...
HRESULT K3D::PipelineStateObject::Initialize(std::string name, D3D12_COMPUTE_PIPELINE_STATE_DESC & cpsDesc, std::weak_ptr<RootSignature> rootSignature)
{
	_rootSignature = rootSignature;
	cpsDesc.pRootSignature = _rootSignature.lock()->GetSignature().Get();
...
HRESULT K3D::PipelineStateObject::Initialize(std::shared_ptr<D3D12Device>& device, std::string name, D3D12_COMPUTE_PIPELINE_STATE_DESC & cpsDesc, std::weak_ptr<RootSignature> rootSignature)
{
	_rootSignature = rootSignature;
	cpsDesc.pRootSignature = _rootSignature.lock()->GetSignature().Get();
