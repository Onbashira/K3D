...
void K3D::Window::CreateScissorRect(UINT width, UINT height)
{
	// シザー矩形を設定.
	_scissorRect.left = 0;
...
void K3D::Window::CreateViewPort(UINT width, UINT height)
{
...
HRESULT K3D::Window::CustomCreate(std::wstring windowName, UINT width, UINT height, LRESULT(_stdcall*windowProc)(HWND, UINT, WPARAM, LPARAM))
{
	this->_appClassName = windowName;
...
HWND & K3D::Window::GetWindowHandle()
{
	return this->_hWindow;
}

HINSTANCE & K3D::Window::GetWindowInstance()
{
	return this->_hInstance;
}

D3D12_VIEWPORT  K3D::Window::GetViewPort()
{
	return _viewPort;
}

D3D12_RECT  K3D::Window::GetScissorRect()
{
	return _scissorRect;
}

void K3D::Window::Discard()
{
