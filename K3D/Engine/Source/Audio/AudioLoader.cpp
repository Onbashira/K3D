...
void K3D::AudioLoader::StopLoad()
{
	_isStop = true;
}

void K3D::AudioLoader::ReStartLoad()
{
	_isStop = false;
}

bool K3D::AudioLoader::IsStopLoad()
{
	return _isStop;
}

void K3D::AudioLoader::DiscardWorkerThreads()
{
	this->_loadThreadPool.DiscardWorkers();
}

std::shared_ptr<K3D::AudioWaveSource> K3D::AudioLoader::LoadAudio(std::string audioFilePath)
{
	...
	std::shared_ptr<K3D::AudioWaveSource> res = std::make_shared<K3D::AudioWaveSource>();
	...
	//フォーマットセット
	{
		...
		res->_format.Format.wBitsPerSample = static_cast<unsigned short>(K3D::Util::ConvertByteToBit<float>()); //1サンプル点当たりのビット数
...
std::shared_ptr<K3D::AudioWaveSource> K3D::AudioLoader::LoadAudioEx(std::string audioFilePath)
{
	if (AudioSourceManager::GetInstance().IsLoaded(audioFilePath)) {
		return AudioSourceManager::GetInstance().GetResource(audioFilePath).lock();
	}
...
void K3D::LoadStereo(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
...
void K3D::LoadMonaural(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
	switch (rawFormatSampleBit)
	{
	case 8:
...
void K3D::LoadStereo8bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
...
void K3D::LoadStereo16bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
...
void K3D::LoadStereo24bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
...
void K3D::LoadStereo32bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
...
void K3D::LoadMonaural8bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
}

void K3D::LoadMonaural16bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
}

void K3D::LoadMonaural24bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
}

void K3D::LoadMonaural32bitSound(HMMIO mmio, AudioWaveSource & wave, MMCKINFO & dataChunk, unsigned int rawFormatSampleBit, unsigned int firstReadIndex)
{
}
