...
HRESULT K3D::D2DDevice::Initialize(std::shared_ptr<D3D11On12Device>& d3d11On12Device)
{
...
Microsoft::WRL::ComPtr<ID2D1Device2>& K3D::D2DDevice::GetD2DDevice()
{
	return _d2dDevice;

}

Microsoft::WRL::ComPtr<ID2D1Factory3>& K3D::D2DDevice::GetD2DFactory()
{
	return _d2dFactory;
}

Microsoft::WRL::ComPtr<ID2D1DeviceContext2>& K3D::D2DDevice::GetD2DDeviceContext()
{
	return _d2dDeviceContext;
}

Microsoft::WRL::ComPtr<IDWriteFactory>& K3D::D2DDevice::GetDWriteFactory()
{
	return _dwriteFacotry;
}

void K3D::D2DDevice::Discard()
{
...
HRESULT K3D::D2DDevice::CreateD2DFactory(std::shared_ptr<D3D11On12Device>& d3d11On12Device, Microsoft::WRL::ComPtr<IDXGIDevice>& dxgiDevice)
{
...
HRESULT K3D::D2DDevice::CreateD2DDevice(std::shared_ptr<D3D11On12Device>& d3d11On12Device, Microsoft::WRL::ComPtr<IDXGIDevice>& dxgiDevice)
{
...
HRESULT K3D::D2DDevice::CreateD2DDeviceContext()
{
	HRESULT ret = {};
...
HRESULT K3D::D2DDevice::CreateDWriteDevice()
{
	HRESULT ret = {};
