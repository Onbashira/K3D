...
K3D::RootSignature::RootSignature()  :
...
HRESULT K3D::RootSignature::CreateFromShader(ID3DBlob * shader)
{
...
HRESULT K3D::RootSignature::CreateFromDesc(D3D12_ROOT_SIGNATURE_DESC * desc)
{
	Microsoft::WRL::ComPtr<ID3DBlob> signature;
...
void K3D::RootSignature::SetName(std::string name)
{
...
void K3D::RootSignature::Discard()
{
	if (_rootSignature.Get() != nullptr) {
