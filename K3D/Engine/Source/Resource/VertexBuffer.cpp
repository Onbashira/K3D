...
HRESULT K3D::VertexBuffer::Create(ULONG64 size, UINT stride, const void * pVertices)
{
	...
	auto hr = Framework::GetDevice().GetDevice()->CreateCommittedResource(&prop, D3D12_HEAP_FLAG_NONE, &desc, D3D12_RESOURCE_STATE_GENERIC_READ, nullptr, IID_PPV_ARGS(GetAddressOf()));
