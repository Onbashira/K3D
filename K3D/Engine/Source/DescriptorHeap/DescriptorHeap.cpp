...
HRESULT K3D::DescriptorHeap::Create(D3D12_DESCRIPTOR_HEAP_DESC* desc)
{
	if (desc == nullptr) {
		return E_FAIL;
	}
...
HRESULT K3D::DescriptorHeap::Create(D3D12_DESCRIPTOR_HEAP_TYPE type, unsigned int numDescriptors, unsigned int nodeMask)
{
