...
K3D::VariableSizeAllocationManager::VariableSizeAllocationManager(OffsetType maxSize, OffsetType alignment) :
	_freeSize(maxSize),
	_maxSize(maxSize),
	_freeBlocksByOffset(),
	_freeBlocksBySize()
...
K3D::VariableSizeAllocationManager::~VariableSizeAllocationManager()
{
}

K3D::VariableSizeAllocationManager::OffsetType K3D::VariableSizeAllocationManager::Allocate(OffsetType size)
{
...
void K3D::VariableSizeAllocationManager::Free(OffsetType offset, OffsetType size)
{
...
void K3D::VariableSizeAllocationManager::AddNewBlock(OffsetType offset, OffsetType size)
{	
...
void K3D::VariableSizeAllocationManager::ResetCurrAlignment()
{
}
