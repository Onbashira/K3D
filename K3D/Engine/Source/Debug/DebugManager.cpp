...
IMGUI_IMPL_API LRESULT K3D::DebugManager::ImGuiWndProcHandler(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
...
void K3D::DebugManager::DebugWindowShutdown()
{
...
std::shared_ptr<K3D::DebugWindow>& K3D::DebugManager::GetDebugWindow()
{
	return _debugWindow;
}

bool K3D::DebugManager::ImGuiInit()
{
	IMGUI_CHECKVERSION();
	ImGui::CreateContext();
	ImGuiIO& io = ImGui::GetIO(); 
...
bool K3D::DebugManager::ImGuiImpleInit(HWND hwnd)
{
...
void K3D::DebugManager::ImGuiNewFrame()
...
bool K3D::DebugManager::ImGuiUpdateMouseCursor()
{
	ImGuiIO& io = ImGui::GetIO();
...
void K3D::DebugManager::ImGuiUpdateMousePos()
{
	ImGuiIO& io = ImGui::GetIO();
	auto& hwnd = Framework::GetInstance().GetWindow().GetWindowHandle();
...
void K3D::DebugManager::ImGuiUpdateGamepads()
{
	{
		ImGuiIO& io = ImGui::GetIO();
