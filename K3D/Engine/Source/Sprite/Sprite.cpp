...
K3D::Sprite::Sprite(std::shared_ptr<GameHeap>& heap) :
...
void K3D::Sprite::Update()
{
}

void K3D::Sprite::Draw(std::shared_ptr<CommandList>& cmdList)
{
	this->_graphicsComponent->Draw(cmdList, this, nullptr, _modelMesh.get());

}

void K3D::Sprite::Initialize()
{
	CreateMesh();
	CreateIndices();
...
void K3D::Sprite::CreateDescriptors()
{
